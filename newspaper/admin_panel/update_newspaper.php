            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <form action="update_newspaper_connect.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="specialist">Edit newspaper details</label>
                    ...
                    <textarea type="text" id="news_info" name="news_info" required> <?php echo $row["news_details"] ?></textarea>
                    <script>
                      tinymce.init({
                        selector: 'textarea',
