                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-dark btn-sm" href="update_my_news.php?tid=<?php echo $user['news_id']; ?>"> Edit</a>
        ...
        <script>
            function confirmation(delid) {
                if (confirm("Do you want to delete?")) {
                    window.location.href = 'my_news_delete.php?tid=' + delid + '';
                    return true;
                }
