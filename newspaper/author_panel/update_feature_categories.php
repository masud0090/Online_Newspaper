        ...
        <div class="panel panel-primary">
            <div class="panel-heading text-center">
                ...
                <div class="panel-body">
                    <form action="update_featured_categories_connect.php" method="post">
                        <div class="form-group">
                            
                                <!--  -->
                                <input type="hidden" name="categories_id" value="<?php echo $row['categories_id']; ?>">
                                <label for="exampleFormControlSelect2"> Course  Name:</label>
                                <lebel><?php echo $row['categories_name'] ; ?></lebel><br>
                        ...
                        <div class="form-group">
                            ...
                            <?php
                                $query1 = "select * from categories where categories.featured=0 ";
