            ...
            <div style="padding:20px; margin-left:70px; margin-top:40px; border:1px solid black;">
              <div class="panel panel-primary">
                ...
                <div class="panel-body">
                  <form action="add_social_link_connect.php" method="post" enctype="multipart/form-data">
                ...
                />
                    ...
                    <?php while ($rows4 = mysqli_fetch_array($res4)) { ?>
                      ...
                      <input type="hidden" name="contact_logo_id" value="<?php echo $rows4['contact_logo_id'] ?>" required>
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="url" name="social_url" size="60%" id="male" value="<?php echo $rows4['url']; ?>"><br>
                        </div>
                        <div class="col-md-3">
