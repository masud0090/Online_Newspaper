...
// if (isset($_GET['id'])) {
$news_id = $_GET['tid'];
$sql32 = "select news_details.news_picture, news_details.news_headline,news_details.news_headline_ban, news_details.news_details,news_details.news_details_ban, news_details.date,news_details.categories_id,news_details.sub_categories_id,categories.categories_name FROM news_details,categories WHERE news_details.news_id=$news_id and news_details.categories_id=categories.categories_id ";

$res32 = mysqli_query($con, $sql32);

$row32 = mysqli_fetch_assoc($res32);

$sub_cat_id = $row32['sub_categories_id'];
          ...
          <div style="padding:20px; margin-left:70px; margin-top:40px; border:1px solid black;">
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <form action="update_newspaper_connect.php" method="post" enctype="multipart/form-data">
                  <div class="form-group">

                    <?php $img = $row32['news_picture']; ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="<?php echo $row32["news_headline"] ?>" required />
                  </div>
                  <div class="form-group">
                                        <label for="bname">Edit Headline (Bangla)</label>
                                        <input type="text" class="form-control" id="name" name="bname" value="<?php echo $row32["news_headline_ban"] ?>" required />
                                    </div>
                                    ...
                                    <?php echo $row32["news_details_ban"] ?>
                                        </textarea>
                                    <br> 
                  ...
                  <div class="form-group">
                    ...
                    <select id="category" class="form-control" name="categories_id" required>
                      ...
                      ?>
                      <option value="<?php echo $row32['categories_id']; ?>"> <?php echo $row32['categories_name']; ?></option>
                      <?php
                      if ($res3->num_rows > 0) {
