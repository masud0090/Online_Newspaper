          ...
          <div style="padding:20px; margin-left:70px; margin-top:40px; border:1px solid black;">
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <form action="update_drafts_connect.php" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="picture" name="picture" value="<?php echo $row["news_picture"] ?>" />
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <select id="sub_category" name="sub" class="form-control" height="15px">
                      ...
                      <?php
                      if ($sub_cat_id != 0) {
                        $sql33 = "select sub_categories_name,sub_categories_id from sub_categories where sub_categories_id=$sub_cat_id";
              ...
              <div class="form-group">
                ...
                />
                  ...
                  <input type="submit" name="update" value="Drafts" class="btn btn-primary">
                </form>
