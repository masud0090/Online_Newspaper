    ...
    <div class="breadcrumb-wrap">
        <div class="container">
            <ul class="breadcrumb">
                ...
                ?>
                    <li class="breadcrumb-item"><a href="categori.php?cat=<?php echo $home['categories_id']; ?>"><?php echo $home['categories_name']; ?></a></li>
                <?php
                }
                ?>
                ...
                <div class="col-lg-8">
                    <div class="sn-container">
                        ...
                        <div class="sn-content">
                            ...
                            <h1 class="sn-title"><?php echo $row1['news_headline']; ?></h1>
                            <?php echo $row1['news_details']; ?>
                            <!-- <p>
                    ...
                    <div class="sn-related">
                        <h2>Most Viewed List In This Category</h2>
                            ...
                            ?>
                                <div class="col-md-4">
                                    <div class="sn-img">
                                        ...
                                        <div class="sn-title">
                                            <a href="single-page.php?nid=<?php echo $m_cat1_rows['news_id']; ?>"><?php echo $m_cat1_rows['news_headline']; ?></a>
                                        </div>
                                    </div>
                                </div>
                            <?php
                ...
                <div class="col-lg-4">
                    <div class="sidebar">
                            ...
                            <div class="news-list">
                                ...
                                ?>
                                    <div class="nl-item">
                                        ...
                                        <div class="nl-title">
                                            <a href="single-page.php?nid=<?php echo $cat1_rows['news_id']; ?>"><?php echo $cat1_rows['news_headline']; ?></a>
                                        </div>
                                    </div>
                                    <!-- <div class="nl-item">
                                        <div class="nl-img">
                            ...
                            <div class="tab-news">
                                ...
                                <div class="tab-content">
                                    <div id="featured" class="container tab-pane active">
                                        ...
                                        ?>
                                            ...
                                            <div class="tn-news">
                                                ...
                                                <div class="tn-title">
                                                    <a href="single-page.php?nid=<?php echo $row9['news_id']; ?>"><?php echo $row9['news_headline']; ?></a>
                                                </div>
                                            </div>
                                        <?php
                                        ...
                                        <a class=" read_more btn btn-primary" href="featured_more_list.php" role="button">VIEW MORE</a>
                                    ...
                                    <div id="popular" class="container tab-pane fade">
                                        ...
                                        ?>
                                            <div class="tn-news">
                                                ...
                                                <div class="tn-title">
                                                    <a href="single-page.php?nid=<?php echo $row5['news_id']; ?>"><?php echo $row5['news_headline']; ?></a>
                                                </div>
                                            </div>
                                        <?php
                                        ...
                                        <a class=" read_more btn btn-primary" href="more_recent_list.php" role="button">VIEW MORE</a>
                                    ...
                                    <div id="latest" class="container tab-pane fade">
                                        ...
                                        <a class=" read_more btn btn-primary" href="viewed_more_list.php" role="button">VIEW MORE</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sidebar-widget">
                            ...
                            <?php
                            $query = "select cat.categories_id cat_id, cat.categories_name cat_name, COUNT(n.news_id) count_name FROM news_details n, categories cat WHERE cat.categories_id=n.categories_id and n.status='Published' group BY cat.categories_name";
